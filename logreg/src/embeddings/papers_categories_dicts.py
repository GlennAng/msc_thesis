...
CATEGORIES_ORIGINAL = ["Physics", "Computer Science", "Mathematics", "Astronomy", "Biology", "Medicine", "Engineering", "Chemistry",
                       "Economics", "Psychology", "Electrical Engineering", "Materials Science", "Earth Science", "Linguistics",
...
PAPERS_CATEGORIES_ORIGINAL = PapersCategories(
    ...
    categories_to_glove = {
        ...
        "Electrical Engineering": {"engineering": 1.0 - DOMAIN_PROBABILITY, "electrical" : DOMAIN_PROBABILITY},
        "Materials Science": {"materials": 1.0 - SCIENCE_PROBABILITY, "science" : SCIENCE_PROBABILITY},
