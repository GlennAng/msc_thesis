...
def create_example_config() -> dict:
    ...
    example_config.update({"min_n_negrated": 20, "min_n_posrated": 20})
    example_config.update({"min_n_negrated_train": None, "min_n_posrated_train": None, "min_n_negrated_val": None, "min_n_posrated_val": None})
    ...
    example_config.update({"embedding_folder": str(PATHS["embeddings_path"] / "after_pca" / "gte_large_2025-02-23_256_categories_100_l2_unit"),
...
if __name__ == "__main__":
    logreg_experiments_path = PATHS["experiments_path"]
