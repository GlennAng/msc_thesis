...
class Score(Enum):
    ...
    INFO_NCE_ALL = auto()
SCORES_DICT = { Score.POSITIVE_GT_RATIO: {"name": "Positive Ground Truth Ratio", "abbreviation": "PGTRo", "increase_better": True, "derivable": False, "ranking": False, "page": 0},
                Score.POSITIVE_PRED_RATIO: {"name": "Positive Prediction Ratio", "abbreviation": "PPRRo", "increase_better": True, "derivable": False, "ranking": False, "page": 0},
                Score.TRUE_POSITIVE_RATIO: {"name": "True Positive Ratio", "abbreviation": "TPRo", "increase_better": True, "derivable": False, "ranking": False, "page": 0},
                Score.FALSE_POSITIVE_RATIO: {"name": "False Positive Ratio", "abbreviation": "FPRo", "increase_better": False, "derivable": False, "ranking": False, "page": 0},
                Score.TRUE_NEGATIVE_RATIO: {"name": "True Negative Ratio", "abbreviation": "TNRo", "increase_better": True, "derivable": False, "ranking": False, "page": 0},
                Score.FALSE_NEGATIVE_RATIO: {"name": "False Negative Ratio", "abbreviation": "FNRo", "increase_better": False, "derivable": False, "ranking": False, "page": 0},
                Score.ACCURACY: {"name": "Accuracy", "abbreviation": "ACC", "increase_better": True, "derivable": False, "ranking": False, "page": 0},
                Score.RECALL: {"name": "Recall", "abbreviation": "REC", "increase_better": True, "derivable": False, "ranking": False, "page": 0},
                Score.SPECIFICITY: {"name": "Specificity", "abbreviation": "SPE", "increase_better": True, "derivable": False, "ranking": False, "page": 0},
                Score.BALANCED_ACCURACY: {"name": "Balanced Accuracy", "abbreviation": "BAL", "increase_better": True, "derivable": True, "ranking": False, "page": 0},
                Score.PRECISION: {"name": "Precision", "abbreviation": "PRE", "increase_better": True, "derivable": False, "ranking": False, "page": 0},
                Score.CEL: {"name": "Cross-Entropy Loss", "abbreviation": "CEL", "increase_better": False, "derivable": False, "ranking": False, "page": 0},
                Score.CEL_POS: {"name": "CEL positive GT", "abbreviation": "CELP", "increase_better": False, "derivable": False, "ranking": False, "page": 0},
                Score.CEL_NEG: {"name": "CEL negative GT", "abbreviation": "CELN", "increase_better": False, "derivable": False, "ranking": False, "page": 0},
                Score.AUROC_CLASSIFICATION: {"name": "Area under Roc Curve Classification", "abbreviation": "AUC_C", "increase_better": True, "derivable": False, "ranking": False, "page": 0},
                Score.NDCG: {"name": "Normalized Discounted Cumulative Gain", "abbreviation": "NDCG", "increase_better": True, "derivable": False, "ranking": True, "page": 0},
                Score.MRR: {"name": "Mean Reciprocal Rank", "abbreviation": "MRR", "increase_better": True, "derivable": False, "ranking": True, "page": 0},
                Score.HIT_RATE_AT_1: {"name": "Hit Rate @ 1", "abbreviation": "HR@1", "increase_better": True, "derivable": False, "ranking": True, "page": 0},
                Score.INFO_NCE: {"name": "InfoNCE", "abbreviation": "INCE", "increase_better": False, "derivable": False, "ranking": True, "page": 0},
                Score.CONFIDENCE_ALL: {"name": "Confidence All", "abbreviation": "C_ALL", "increase_better": True, "derivable": False, "ranking": False, "page": 1},
                Score.CONFIDENCE_TP: {"name": "Confidence True Positives", "abbreviation": "C_TP", "increase_better": True, "derivable": False, "ranking": False, "page": 1},
                Score.CONFIDENCE_FP: {"name": "Confidence False Positives", "abbreviation": "C_FP", "increase_better": False, "derivable": False, "ranking": False, "page": 1},
                Score.CONFIDENCE_TN: {"name": "Confidence True Negatives", "abbreviation": "C_TN", "increase_better": True, "derivable": False, "ranking": False, "page": 1},
                Score.CONFIDENCE_FN: {"name": "Confidence False Negatives", "abbreviation": "C_FN", "increase_better": False, "derivable": False, "ranking": False, "page": 1},
                Score.POSITIVE_GT_ABOVE_THRESHOLD: {"name": f"Positive Ground Truth above {CONFIDENCE_THRESHOLD}", "abbreviation": f"PGTAT\n{CONFIDENCE_THRESHOLD}", 
                                                        "increase_better": True, "derivable": False, "ranking": False, "page": 1},
                Score.SAMPLES_ABOVE_THRESHOLD: {"name": f"Samples above {CONFIDENCE_THRESHOLD}", "abbreviation": f"SAT\n{CONFIDENCE_THRESHOLD}", 
                                                    "increase_better": True, "derivable": False, "ranking": False, "page": 1},
                Score.SPECIFICITY_SAMPLES: {"name": "Specificity Samples", "abbreviation": "SPE\nSmpl", "increase_better": True, "derivable": False, "ranking": False, "page": 1},   
                Score.PRECISION_SAMPLES: {"name": "Precision Samples", "abbreviation": "PRE\nSmpl", "increase_better": True, "derivable": False, "ranking": False, "page": 1},
                Score.CONFIDENCE_ALL_SAMPLES: {"name": "Confidence All Samples", "abbreviation": "C_ALL\nSmpl", "increase_better": False, "derivable": False, "ranking": False, "page": 1},
                Score.CONFIDENCE_TOP_1_SAMPLES: {"name": "Confidence Top 1 Samples", "abbreviation": "C_T1\nSmpl", "increase_better": False, "derivable": False, "ranking": False, "page": 1},
                Score.NDCG_SAMPLES: {"name": "Normalized Discounted Cumulative Gain Samples", "abbreviation": "NDCG\nSmpl", "increase_better": True, "derivable": False, "ranking": True, "page": 1},
                Score.NDCG_ALL: {"name": "Normalized Discounted Cumulative Gain All", "abbreviation": "NDCG\nAll", "increase_better": True, "derivable": False, "ranking": True, "page": 1},
                ...
                Score.INFO_NCE_SAMPLES: {"name": "InfoNCE Samples", "abbreviation": "INCE\nSmpl", "increase_better": False, "derivable": False, "ranking": True, "page": 1},
                Score.INFO_NCE_ALL: {"name": "InfoNCE All", "abbreviation": "INCE\nAll", "increase_better": False, "derivable": False, "ranking": True, "page": 1}
                }
