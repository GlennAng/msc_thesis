...
if __name__ == "__main__":
    data_db_backup_date_path = ProjectPaths.data_db_backup_date_path()

    users_mapping_path = data_db_backup_date_path / "users_mapping.pkl"
    if users_mapping_path.exists():
        users_mapping = load_users_mapping(users_mapping_path)

    users_ratings_mapped_path = data_db_backup_date_path / "users_ratings_mapped.parquet"
    ...
    users_ratings_path = data_db_backup_date_path / "users_ratings.parquet"
    ...
    papers_texts_path = data_db_backup_date_path / "papers_texts.parquet"
    papers_texts = load_papers_texts(papers_texts_path)
    papers_path = data_db_backup_date_path / "papers.parquet"
